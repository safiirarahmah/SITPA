...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: rgb(235, 235, 235);">
	...
	<div class="container mt-3">
		<div class="container mb-3" style="background-color: rgb(235, 235, 235)">
			<div class="row justify-content-center">
				<div class="col-3">
			      <label><h5>Tambah Pengajar</h5></label>
			    </div>
			</div>
		</div>
		<form action="" method="POST" enctype="multipart/form-data">
			...
			<div class="mb-3">
				<input required type="text" class="form-control" name="nama" id="nama_pengajar" placeholder="Nama">
			</div>
			<div class="mb-3">
				<input required type="text" class="form-control" name="no_hp" id="no_hp" placeholder="No.Hp">
			</div>
	...
	<?php
		...
		$query = "INSERT INTO pengajar (nama_pengajar, no_hp) VALUES ('$nama','$no_hp')";
