	...
	<div class="container mt-3">
		<div class="container mb-2">
			<div class="row justify-content-center">
				<div class="col-3">
			      <label><h5>Daftar Pengajar</h5></label>
			    </div>
			</div>
			<div class="row justify-content-end">
			    <div class="col-1">
			      <a class="btn btn-success" href="add_pengajar.php" role="button">Tambah</a>
			    </div>
			</div>
		</div>
		<table class="table">
          ...
          <?php
              ...
              while($data = mysqli_fetch_array($result)) { ?>
			    <tr>
			      <th scope="row"><?= $data['id_pengajar'] ?></th>
			      <td><?= $data['nama_pengajar'] ?></td>
			      <td><?= $data['no_hp'] ?></td>
			     
			      <td><a href="update_pengajar.php?id=<?= $data['id_pengajar']; ?>">update</a> <a href="delete_pengajar.php?id=<?= $data['id_pengajar']; ?>">delete</a></td>
			    </tr>
			<?php } ?>
		  </tbody>
		</table>
